...
//        Class class = [self class];
        [self swizzleMethod:@selector(description) withMethod:@selector(zxp_description)];
        [self swizzleMethod:@selector(descriptionWithLocale:) withMethod:@selector(zxp_descriptionWithLocale:)];
        [self swizzleMethod:@selector(descriptionWithLocale:indent:) withMethod:@selector(zxp_descriptionWithLocale:indent:)];
    });
}
